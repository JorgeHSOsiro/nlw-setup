...
export function HabitsList({date, onConpletedChange}: HabitsListProps) {
    ...
    async function handleToggleHabit(habitId: string) {
        ...
        const isHabitMarkedCompleted = habitsInfo!.completedHabits.includes(habitId);
        let completedHabits: string[] = [];
        if (isHabitMarkedCompleted) {
