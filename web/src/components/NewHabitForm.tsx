    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <input 
                ...
                className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-900"
                autoFocus
                value={title}
            ...
            <div className="flex flex-col gap-2 mt-3">
                {availableWeekDays.map((weekDay, index) => {
                    ...
                    >
                            ...
                            <span className=' text-white leading-tight focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-background'>
                                {weekDay}
                            </span>
